...
public class ImageAvatar extends JComponent{
    ...
    public void setImageFromCSV(String csvFilePath, String username) {
        try (BufferedReader br = new BufferedReader(new FileReader(csvFilePath))) {
            String line;
            while ((line = br.readLine()) != null) {
                String[] values = line.split(";");
                if (values.length > 16 && values[3].equals(username)) { // Assuming the image path is at index 8
                    String imagePath = values[8].trim(); // Adjust the index if necessary
            ...
            e.printStackTrace();
            System.out.println("Error reading CSV file or setting image.");
        }
    }
