 ...
 * @author acer
 */
public class ProfileHR extends javax.swing.JFrame {
 ...
 public String getln(){
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(28, 15, 9));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaasg/image/left-arrow.png"))); // NOI18N
...
private void reloadProfileData() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfileHR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
