// try to add continue history if can
...
public class HR_interface extends javax.swing.JFrame {
    ...
    public HR_interface() {
        ...
        // Create JScrollPane and set JTable to it
        ...
        jScrollPane2.setViewportView(jTable2);  // Set the JTable to the JScrollPane

        // Add JScrollPane to the frame or panel
        getContentPane().add(jScrollPane2, BorderLayout.CENTER);  // Or add to appropriate container
        ...
        setVisible(true);
//        Object[] rowData = null;
//        employeeForm = new EmployeeForm(model, rowData);
//        initializeForm();
