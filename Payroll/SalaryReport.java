...
public class SalaryReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ReportList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Year", "Month", "NRIC", "GrossSalary", "NettSalary", "LateLeaveDeduction", "TotalDeduction", "Advance Salary", "EPF (Employee)", "EPF (Employer)", "SOCSO (Employee)", "SOCSO (Employer)", "EIS (Employee)", "EIS (Employer)", "PCB"
            }
        ) {
    ...
    private void setColumnWidths () {
        ...
        columnModel.getColumn (7).setPreferredWidth (150); // Advance Salary
        columnModel.getColumn (8).setPreferredWidth (150); // EPF (Employee)
        columnModel.getColumn (9).setPreferredWidth (150); // EPF (Employer)
        columnModel.getColumn (10).setPreferredWidth (150); // SOCSO (Employee)
        columnModel.getColumn (11).setPreferredWidth (150); // SOCSO (Employer)
        columnModel.getColumn (12).setPreferredWidth (150); // EIS (Employee)
        columnModel.getColumn (13).setPreferredWidth (150); // EIS (Employer)
        columnModel.getColumn (14).setPreferredWidth (150); // PCB // Monthly Gross Salary
    }
    ...
    private void loadInitialData () {
        ...
        try (BufferedReader br = new BufferedReader (new FileReader (filePath))) {
            ...
            while ((line = br.readLine ()) != null) {
                ...
                rowData[7] = data[15]; // Advance Salary
                rowData[8] = data[11]; // EPF (Employee)
                rowData[9] = data[7]; // EPF (Employer)
                rowData[10] = data[12]; // SOCSO (Employee)
                rowData[11] = data[8]; // SOCSO (Employer)
                rowData[12] = data[13]; // EIS (Employee)
                rowData[13] = data[9]; // EIS (Employer)
                rowData[14] = data[14];//PCB
