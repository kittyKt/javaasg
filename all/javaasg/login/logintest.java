...
import Employees.EmployeePage;
import HR.HR_interface;
import Payroll.Homepage;
import javax.swing.*;
import java.awt.*;
            ...
            if(status.equalsIgnoreCase("Locked")){
                ...
                if (role != null){
                    if (role.equalsIgnoreCase("System Administrator")){
                        ...
                        String[] adminp = getuserDetails();
                        setuserDetails(adminp);
                        EmployeePage emp = new EmployeePage(adminp);
                        emp.setVisible(true);
                        this.dispose();
                        
                    } else if (role.equalsIgnoreCase("Payroll Officer")){
                        String[] adminp = getuserDetails();
                        setuserDetails(adminp);
                        Homepage payroll = new Homepage();
