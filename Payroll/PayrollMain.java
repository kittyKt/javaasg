...
public class PayrollMain extends javax.swing.JFrame {
    ...
    private void initializeMonthYear () {
        ...
        Year.setModel (new DefaultComboBoxModel<> (new String[] {String.valueOf (currentYear)}));

        DefaultComboBoxModel<String> monthModel = new DefaultComboBoxModel<> ();

        currentMonth = months[currentMonthIndex];
        monthModel.addElement (currentMonth);

        if (currentMonthIndex < 11) {
            monthModel.addElement (months[currentMonthIndex + 1]);
        }
        ...
        Month.addActionListener (new ActionListener () {
            ...
            public void actionPerformed (ActionEvent e) {
                currentMonth = (String) Month.getSelectedItem ();
            }
        });
