...
//everything seem to be working alrdy, now oni need to connect
// to homepage (oni need to change name to actual file name
//and see if the back button work properly or not
...
public class StatusPageGUI {
    ...
    private void goBackToHomePage(){
        frame.dispose(); // closes status page
        new HomepageGUI(); // need to hc homepage but ltr just change the name to  connect to it
    }
