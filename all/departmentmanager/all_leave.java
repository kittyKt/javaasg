...
public class all_leave extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Leave Applications");
    ...
    //faqcsv part
    private void loadfaq(String inqfile){
        DefaultTableModel tmodel = (DefaultTableModel)allcsv.getModel();
        tmodel.setRowCount(0);
        try(
            BufferedReader read = new BufferedReader(new FileReader(inqfile))){
            String line;
            boolean fline= true;
