...
public class EmpSalaryDetails extends javax.swing.JPanel {
    ...
    private void initCustomListeners () {
        ...
        addDocumentListeners (UnpaidLeaveCount, LateDays, AdvanceSalary);
    }

    private void calculateDeductions () {
        try {
            int unpaidLeaveDays = getFieldValue (UnpaidLeaveCount);
            int lateDays = getFieldValue (LateDays);
            int advSalary = getFieldValue (AdvanceSalary);
            ...
            double totalDeduction = totalHDDeduction + calculations.calculateTotalDeduction () + advSalary;
    ...
    private void initComponents() {
        ...
        AdvanceSalary = new javax.swing.JTextField();
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Mid Month Advance", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12))); // NOI18N

        jLabel22.setText("Advance: ");

        AdvanceSalary.setForeground(new java.awt.Color(255, 51, 51));
        AdvanceSalary.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AdvanceSalaryActionPerformed(evt);
            }
        });
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel22)
                    .addComponent(AdvanceSalary, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
    ...
    private void AdvanceSalaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdvanceSalaryActionPerformed

    }//GEN-LAST:event_AdvanceSalaryActionPerformed
    ...
    private javax.swing.JTextField AdvanceSalary;
